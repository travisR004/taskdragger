...
(function() { this.JST || (this.JST = {}); this.JST["board/index"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<ul>\n  ');  boards.forEach(function(board){ ; __p.push('\n    <li>\n      <a href="#/boards/',  board.escape("id") ,'">\n      <div class="board">\n          ',  board.escape('title')  ,'\n      </div>\n      </a>\n    </li>\n  ');  }) ; __p.push('\n</ul>\n\n<div class="hidden" id="board-form">\n  ',  JST['board/new']() ,'\n</div>\n\n<div id="new-board-button">\n<button class="btn btn-primary" id="new-board">New Board</button>\n</div>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["board/new"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<form id="new-board-form">\n  <input type="text" name="board[title]">\n\n  <button id="create-board">Create Board</button>\n</form>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["board/show"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<h1> ',  board.escape("title") ,'</h1>\n<a href="#/" class="index-link"> Back to Index </a>\n    <div id="new-list-button">\n      <button id="new-list" class="btn btn btn-primary">Add List</button>\n    </div>\n    <div class="hidden" id="list-form">\n      <form id="new-list-form">\n        <input type="text" name="list[title]" id="list-title" autofocus="autofocus">\n\n        <button id="create-list" class="btn btn-primary">Add List</button>\n          <button id="never-mind" class="btn btn-warning">x</button>\n      </form>\n    </div>\n\n<ul class="lists"></ul>\n\n<button class="btn btn-danger" id="delete-board">Delete Board</button>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["card/show"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<div data-toggle="modal" class="card" id="card',  card.escape("id") ,'" data-target="#my-modal">\n\n  <a href="#" class="hidden delete-card" id="delete-card',  card.escape("id") ,'" data-toggle="popover" data-placement="right"\n    data-content="<a href=\'\' id=\'delete-card\' data-card=\'',  card.get("id") ,'\'>Remove Card</a>">\n    <span class="glyphicon glyphicon-flash" style="top: 0px;"></span>\n  </a>\n\n  ',  card.escape("title") ,'\n\n</div>\n\n<div class="modal fade" id="my-modal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">\n  <div class="modal-dialog">\n    <div class="modal-content">\n      <div class="modal-header">\n        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>\n        <h4 class="modal-title" id="myModalLabel">',  card.escape("title") ,'</h4>\n      </div>\n      <div class="modal-body">\n        ',  card.escape("description") ,'\n      </div>\n      <div class="modal-footer">\n        <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>\n        <button type="button" class="btn btn-primary">Save changes</button>\n      </div>\n    </div>\n  </div>\n</div>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["list/show"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<div class="list-item" id="list-item',  list.escape("id") ,'">\n\n  <a href="#" class="hidden delete-list" id="delete-list',  list.escape("id") ,'" data-toggle="popover" data-placement="right"\n    data-content="<a href=\'\' id=\'delete-list\' data-list=\'',  list.get("id") ,'\'>Remove List</a>">\n    <span class="glyphicon glyphicon-pushpin" style="top: 0px;"></span>\n  </a>\n\n  ',  list.escape('title') ,'\n\n\n  <div class="list',  list.escape("id") ,' list"></div>\n\n  <div class="add-cards',  list.escape("id") ,'">\n\n    <button\n      class="add-card btn btn-primary"\n      id="add-card',  list.escape("id") ,'">Add Card\n    </button>\n\n    <form id="card-form',  list.escape("id") ,'" class="card-form hidden">\n      <label>Title\n        <input type="text" name="card[title]" class="card-input" id="card-title',  list.escape("id") ,'" autofocus="autofocus">\n      </label>\n\n      <label>Description\n        <textarea class="card-input" name="card[description]" id="card-description',  list.escape("id") ,'"></textarea>\n      </label>\n\n      <button class="create-card btn btn-primary">Add Card</button>\n      <button id="never-mind-card" class="btn btn-warning x-button">x</button>\n    </form>\n  </div>\n</div>\n');}return __p.join('');};
}).call(this);
